...
# Taken from: https://rdrr.io/github/HannaMeyer/sptm/src/R/GMSummary.R
# Copied here to avoid installation issues (package not on CRAN + "sptm" there is a completely different package)

#' Geometric mean for model evaluation
#' @description Provides functionality to evaluate a model using the geometric mean as described in Galar et al., 2014.
